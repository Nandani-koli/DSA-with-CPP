                          ...
                          vector<int> index_page)
{
         ...
         i++)
    {
        cout << "|"
             ...
             << index_page.at(i)
             << string(7 - to_string(index_page.at(i)).length().length() / 2,'')
             << "|";
        j = index_page
                .at(i);
        fname = memory
        ...
        cout << string(7 - to_string(j).length() / 2 - to_string(j).length() % 2,'')
             ...
             << j - index_page.at(i) + 1
             << string(9 - to_string(j - index_page.at(i) + 1).length() / 2,'')
             << "|"
             << endl;
    }
    cout << "+" << string(max + 2, '-')
    ...
    if (file_exists(memory, filename))
    {
        ...
        while (index < memory.size() && memory.at(index).get_file_name() == filename && !memory.at(index).is_empty())
        {
            cout << "|"
                 ...
                 << index
                 << string(9 - to_string(index).length() / 2,'')
                 << "|"
                 ...
                 << string(9 - to_string(memory.at(index).get_file_partition_no()).length() / 2,'')
                 << "|"
                 << endl;
            index++;
        }
